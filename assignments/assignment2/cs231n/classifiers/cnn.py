...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Backward pass
        dloss, grads["W3"], grads["b3"] = affine_backward(dloss, a_cache)
        dloss, grads["W2"], grads["b2"] = affine_relu_backward(dloss, ar_cache)
        dloss, grads["W1"], grads["b1"] = conv_relu_pool_backward(dloss, crp_cache)
